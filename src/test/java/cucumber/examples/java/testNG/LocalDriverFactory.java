...
public class LocalDriverFactory {
    public static WebDriver createInstance(String browserName) {
        ...
        switch (Browser.valueOf(browserName.toUpperCase())) {
            case FIREFOX:
                System.setProperty("webdriver.gecko.driver", "C:\\Users\\Fission Labs\\Downloads\\geckodriver.exe");
            ...
            case IE:
                ...
                break;
            case CHROME:
                System.setProperty("webdriver.chrome.driver", "C:\\Users\\Fission Labs\\Downloads\\chromedriver_win32\\chromedriver.exe");
