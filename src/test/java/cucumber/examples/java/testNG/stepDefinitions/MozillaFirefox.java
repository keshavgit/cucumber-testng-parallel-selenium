...
public class MozillaFirefox {
    ...
    static Logger log = Logger.getLogger(MozillaFirefox.class);
...
//        setProperty("webdriver.chrome.driver", "C:\\Users\\Fission Labs\\Downloads\\chromedriver_win32\\chromedriver.exe");
    ...
    public void signInToWebsite() throws Throwable {
        // Write code here that turns the phrase above into concrete actions
    ...
    public void search_for_a_product() throws Throwable {
        // Write code here that turns the phrase above into concrete actions
        WebElement element = (WebElement) driver.findElement(By.name("ctl00$MasterHeader$ctl00$uchead$GlobalSearchUC$TxtSearchKeyword"));
        element.sendKeys("Samsung curve", Keys.ENTER);
        ...
        //driver.findElement(By.xpath("//a[contains(text(),'Touchscreen Laptop - Silver')]")).click();
    ...
    public void proceed_to_Checkout() throws Throwable {
        ...
        yourElement .click();
        driver.findElement(By.name("ctl00$CP$checkoutSections$ctl01$DeliveryOptionTabs1$manageShippingAddress$oeaUseNew$addressUC$FirstNameContainer$TxtFirstName")).sendKeys("Firefox");
    ...
    @Then("^Select Payment Gateway$")
    public void select_Payment_Gateway() throws Throwable {
        // Write code here that turns the phrase above into concrete actions
        Thread.sleep(3000);
